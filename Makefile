...
SOURCE_FILES := main.c uart.c test_sram.c test.c adc.c breadboard_input.c oled.c menu.c spi.c mcp_driver.c can.c
...
CC := avr-gcc
CFLAGS := -Os -Wall -Wextra -std=c11 -mmcu=$(TARGET_CPU)
